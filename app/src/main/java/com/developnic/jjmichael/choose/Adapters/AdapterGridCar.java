...
public class AdapterGridCar extends RecyclerView.Adapter<AdapterGridCar.ViewHolder> implements ItemClickListener {
    ...
    public AdapterGridCar(boolean horizontal, boolean pager, List<Carreras> carreras, Context context) {
    ...
    public AdapterGridCar(ViewHolder viewHolder, List<Carreras> carrerasPopulares) {
    }

    public AdapterGridCar ( Context context, List<Carreras> items){
        this.context = context;
        this.items = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        return new ViewHolder(LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_list_carreras_horizontal, viewGroup, false),this);
